package com.seatrend.android.datescroller;
...
import com.seatrend.android.datescroller.config.ScrollerConfig;
import com.seatrend.android.datescroller.data.Type;
import com.seatrend.android.datescroller.data.WheelCalendar;
...
public class DateScrollerDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void measureContainerHeight(FrameLayout container) {
        int containerHeight = mScrollerConfig.mContext.getResources().getDisplayMetrics().heightPixels / 2;
     ...
     * @return 当前视图
     */
    private View initView() throws NullPointerException {
        LayoutInflater inflater = LayoutInflater.from(getContext());
        final ViewGroup nullParent = null;
        View view = inflater.inflate(R.layout.timepicker_layout_cpmall, nullParent);

        FrameLayout containerFL = view.findViewById(R.id.containerFL);
        if (containerFL != null) {
            measureContainerHeight(containerFL);
        }
        ...
        ImageView close = view.findViewById(R.id.closeIV);
        if (close != null) {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.tv_cancel || i == R.id.closeIV) {
            dismiss(); // 取消
    ...
    public static class Builder {
        ...
        public Builder setContext(Context context) {
            mScrollerConfig.mContext = context;
            return this;
        }
