package com.seatrend.android.datescroller.config;
...
public class DefaultConfig {
    ...
    public static final int TV_NORMAL_COLOR = 0x80333333; // 默认文字颜色
    public static final int TV_SELECTOR_COLOR = 0XFF333333; // 选中文字颜色
